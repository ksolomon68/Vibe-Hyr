...
<body style="margin:0;padding:0;background:${r};font-family:'Helvetica Neue',Arial,sans-serif;">
  ...
  </table>`}let d='<div style="height:1px;background:#E4DDD4;margin:28px 0;"></div>';function g(e){return`<h1 style="margin:0 0 12px;font-size:36px;font-weight:900;letter-spacing:3px;text-transform:uppercase;color:${a};line-height:1.1;">${e}</h1>`}function f(e){return`<p style="margin:0 0 8px;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:${s};font-family:monospace;">${e}</p>`}function u(e,t=!1){return`<p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:${l};${t?"font-style:italic;":""}">${e}</p>`}function y(e){return p(`
    ${f("Password Reset")}
    ${g("Reset Your Access")}
    ${d}
    ${u("We received a request to reset the password for your Vibe Hyr account. Click the button below to choose a new password.")}
    ${u('This link is valid for <strong style="color:${INK}">60 minutes</strong> and can only be used once. If you did not request a password reset, you can safely ignore this email.')}
  ...
  `)}function h(e,t,o,r,n=[]){let i=e?.split(" ")[0]||"Member",y=n.length>0?`${d}
    ...
    ${f(`${t} \xb7 Vibe Hyr`)}
    ${g(`You've Been<br/><span style="color:${s};">Invited.</span>`)}
    ${d}
    ${u(`Hi ${i}, you've been invited to join <strong style="color:${a};">${t}</strong> on the Vibe Hyr platform as a <strong style="color:${a};">${"educator"===o?"Educator":"leader"===o?"Leader":"Team Member"}</strong>.`)}
    ${u("Vibe Hyr is a professional development platform built on identity-level transformation — helping individuals and teams govern their external results from the inside out.")}
    ${u("Click the button below to set your password and access your assigned courses:")}
    ${y}
  ...
  `)}function m(e,t,o){let r=e?.split(" ")[0]||"Member";return p(`
    ${f("Welcome to Vibe Hyr")}
    ${g(`Your Account<br/><span style="color:${s};">Is Ready.</span>`)}
    ${d}
    ${u(`Hi ${r}, your Vibe Hyr account has been created with <strong style="color:${a};">${"elite"===t?"Reality Master":"architect"===t?"Architect":"Seeker"}</strong> access.`)}
    ${u("Your account is active and waiting for you. Click below to set your password and begin:")}
  ...
  `)}},25504:(e,t,o)=>{o.d(t,{i:()=>n});var r=o(98406);function n(){return(0,r.eI)(process.env.NEXT_PUBLIC_SUPABASE_URL,process.env.SUPABASE_SERVICE_ROLE_KEY,{auth:{persistSession:!1,autoRefreshToken:!1}})}},71870:(e,t,o)=>{o.d(t,{e:()=>i});var r=o(26407),n=o(53973);function i(){let e=(0,n.cookies)();return(0,r.createServerClient)(process.env.NEXT_PUBLIC_SUPABASE_URL,process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY,{cookies:{getAll:()=>e.getAll(),setAll(t){try{t.forEach(({name:t,value:o,options:r})=>e.set(t,o,r))}catch{}}}})}},65655:(e,t,o)=>{o.d(t,{e:()=>i});var r=o(67721),n=o(71615);function i(){let e=(0,n.cookies)();return(0,r.createServerClient)(process.env.NEXT_PUBLIC_SUPABASE_URL,process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY,{cookies:{getAll:()=>e.getAll(),setAll(t){try{t.forEach(({name:t,value:o,options:r})=>e.set(t,o,r))}catch{}}}})}}};