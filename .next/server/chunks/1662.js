"use strict";exports.id=1662,exports.ids=[1662],exports.modules={91662:(e,t,i)=>{i.d(t,{COURSE_01_LESSONS:()=>o,COURSE_02_LESSONS:()=>n,COURSE_03_LESSONS:()=>s,COURSE_04_LESSONS:()=>a}),new Date().toISOString(),new Date().toISOString(),new Date().toISOString(),new Date().toISOString(),new Date().toISOString(),new Date().toISOString();let o=[{id:"c01-l01",course_id:"c01",order_index:1,title:"The 11 Million Bit Problem",description:"Your brain is drowning in data every second. Understand why it filters almost everything out — and who controls the filter.",video_url:"https://www.youtube.com/embed/mTjDPbUC44U",duration_seconds:720,is_preview:!0,content_md:`## The 11 Million Bit Problem
...
The subconscious is being impressed. Persistently, deliberately, consistently — for 30 days. Then watch what echoes back.`,created_at:new Date().toISOString()}],s=[{id:"c03-l01",course_id:"c03",order_index:1,title:"What Is SATS — and Why It Works",description:"The science and mysticism behind the hypnagogic state — the most direct access point to the subconscious mind ever identified.",video_url:null,duration_seconds:840,is_preview:!1,content_md:`## What Is SATS — and Why It Works
...
✦`,created_at:new Date().toISOString()}];new Date().toISOString(),new Date().toISOString(),new Date().toISOString(),new Date().toISOString()}};