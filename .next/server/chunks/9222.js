"use strict";exports.id=9222,exports.ids=[9222],exports.modules={79222:(e,t,i)=>{i.d(t,{k:()=>s});var o=i(19658),n=i(73201);function a(e){var t,i,o;let n=(t=e.course_id)>=1&&t<=4?`c0${t}`:t>=5&&t<=8?`b0${t-4}`:t>=9&&t<=12?`ed0${t-8}`:t>=13&&t<=16?`leadership_course_${t-12}`:`unknown_${t}`,a=e.title.toLowerCase().replace(/['']/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"");return n.startsWith("c0")?a=`${n}-l${e.sort_order.toString().padStart(2,"0")}`:n.startsWith("ed0")?a=`${n}-m${e.sort_order.toString().padStart(2,"0")}`:n.startsWith("b0")&&(a=`${n}-l${e.sort_order.toString().padStart(2,"0")}`),{id:a,course_id:n,order_index:e.sort_order,title:e.title,description:"",video_url:e.youtube_url?function(e){let t=e.match(/(?:youtube\.com\/watch\?v=|youtu\.be\/|youtube\.com\/embed\/)([^&\s?#]+)/);return t?`https://www.youtube-nocookie.com/embed/${t[1]}?rel=0&modestbranding=1&controls=1`:e}(e.youtube_url):null,duration_seconds:(i=e.type,o=e.content,"video"===i?900:o?60*Math.max(5,Math.ceil(o.replace(/<[^>]*>/g,"").length/1e3)):300),is_preview:e.is_preview,content_md:"text"===e.type||"video"===e.type?e.content??"":"header"===e.type?`## ${e.title}`:"",created_at:e.created_at}}async function s(e,t){let i=(0,o.createAdminClient)(),{data:s,error:r}=await i.from("course_lessons").select("*").eq("course_id",t).eq("is_published",!0).order("sort_order",{ascending:!0});return r||!s||0===s.length?(0,n.aX)(e):s.map(a)}},73201:(e,t,i)=>{i.d(t,{nP:()=>p,K2:()=>m,aX:()=>u});let o=[{id:"b01-l01",course_id:"b01",order_index:1,title:"The Professional Filter — Why Teams Miss the Obvious",description:"In a business environment, the RAS filters for problems or opportunities. Most teams are programmed to see only the fires.",video_url:null,duration_seconds:900,is_preview:!0,content_md:`## The Professional Filter
...
### The Business Impact
When you change the filter from "what is going wrong" to "what is possible here," the same conference room becomes a different environment.`,created_at:new Date().toISOString()},{id:"b01-l02",course_id:"b01",order_index:2,title:"The Innovation Bias",description:"How to program your team to notice the subtle signals that lead to market breakthroughs.",video_url:null,duration_seconds:840,is_preview:!0,content_md:`## The Innovation Bias
...
Innovation isn't about creating something from nothing—it's about **noticing** what was previously filtered out.`,created_at:new Date().toISOString()},{id:"b01-l03",course_id:"b01",order_index:3,title:"The Deep Work State — Alpha in the Office",description:"The science of high-performance focus and how to move from frantic Beta to productive Alpha.",video_url:null,duration_seconds:960,is_preview:!1,content_md:`## The Deep Work State

Most workplace stress happens in high-frequency **Beta**. True productivity—the kind that moves the needle—happens in **Alpha**.

We'll learn how to transition your team into a collective Alpha state for collaborative problem solving.`,created_at:new Date().toISOString()},{id:"b01-l04",course_id:"b01",order_index:4,title:"Reprogramming Organizational Culture",description:"Clarity, Emotion, and Repetition applied to team goals.",video_url:null,duration_seconds:900,is_preview:!1,content_md:`## Reprogramming Culture

A company culture is simply the **collective RAS** of its employees. To change the culture, you must change the shared filtering instructions.`,created_at:new Date().toISOString()},{id:"b01-l05",course_id:"b01",order_index:5,title:"Module Quiz & Workplace RAS Audit",description:"Test your understanding and receive your first team-wide reprogramming assignment.",video_url:null,duration_seconds:300,is_preview:!1,content_md:`## Workplace RAS Audit

Complete the knowledge check below to unlock **Course B02: From Reaction to Response**.`,created_at:new Date().toISOString()}],n={"b01-l05":{id:"quiz-b01-final",course_id:"b01",lesson_id:"b01-l05",title:"Workplace Mastery Check",description:null,quiz_type:"knowledge_check",tier_required:"free",pass_percent:70,created_at:new Date().toISOString(),questions:[{id:"q-b01-1",quiz_id:"quiz-b01-final",order_index:1,correct_option_id:"q-b01-1-b",explanation:"The RAS acts as the gatekeeper for all professional sensory input.",question:"What is the primary role of the RAS in a professional context?",options:[{id:"q-b01-1-a",label:"A",text:"To manage your calendar",feedback:null},{id:"q-b01-1-b",label:"B",text:"To filter environmental data based on priorities",feedback:null},{id:"q-b01-1-c",label:"C",text:"To increase typing speed",feedback:null},{id:"q-b01-1-d",label:"D",text:"To regulate office temperature",feedback:null}]}]}},a=[{id:"c01-l01",course_id:"c01",order_index:1,title:"The 11 Million Bit Problem",description:"Your brain is drowning in data every second. Understand why it filters almost everything out — and who controls the filter.",video_url:"https://www.youtube.com/embed/mTjDPbUC44U",duration_seconds:720,is_preview:!0,content_md:`## The 11 Million Bit Problem
...
That desire is the first filtering instruction we're going to install.`,created_at:new Date().toISOString()},{id:"c01-l02",course_id:"c01",order_index:2,title:"The Car Model Phenomenon",description:"Why you suddenly see your desired car everywhere after deciding to buy it — and how to weaponize this effect for every goal.",video_url:"https://www.youtube.com/embed/7zzyEcLtreA",duration_seconds:840,is_preview:!0,content_md:`## The Car Model Phenomenon
...
We'll build each of these systematically across this course.`,created_at:new Date().toISOString()},{id:"c01-l03",course_id:"c01",order_index:3,title:"Beta, Alpha, Theta — Your Three Operating Modes",description:"Your brain runs on different frequencies. Each one has a different relationship with your beliefs — and one is the master key to the subconscious.",video_url:"https://www.youtube.com/embed/3oASflIFWHs",duration_seconds:960,is_preview:!1,content_md:`## Beta, Alpha, Theta — Your Three Operating Modes
...
Each morning and evening, for just 5 minutes, enter a relaxed state (eyes closed, slow breathing) and hold your desired outcome in mind with genuine feeling. You're practicing the Alpha entry point — the first step toward the Theta gateway.`,created_at:new Date().toISOString()},{id:"c01-l04",course_id:"c01",order_index:4,title:"Installing New Filtering Instructions",description:"The three-part protocol for deliberately reprogramming your RAS — clarity, emotion, and repetition working in sequence.",video_url:"https://www.youtube.com/embed/UvDAAwlFQBY",duration_seconds:900,is_preview:!1,content_md:`## Installing New Filtering Instructions
...
This is the beginning of the Mental Diet. We'll master this in Course 4.`,created_at:new Date().toISOString()},{id:"c01-l05",course_id:"c01",order_index:5,title:"Module Quiz & Your RAS Assignment",description:"Test your understanding of the RAS framework and receive your 7-day reprogramming assignment.",video_url:null,duration_seconds:300,is_preview:!1,content_md:`## Module Quiz & Your RAS Assignment
...
After completing the quiz, you've unlocked **Course 2: Mastery of the Law of Assumption** (Architect tier).`,created_at:new Date().toISOString()}],s=[{id:"c02-l01",course_id:"c02",order_index:1,title:"The Law vs. The Law of Attraction",description:"The critical distinction that changes everything — you're not attracting from outside, you're selecting from within.",video_url:null,duration_seconds:840,is_preview:!1,content_md:`## The Law vs. The Law of Attraction
...
One keeps the desire at arm's length. The other **collapses the distance entirely**.`,created_at:new Date().toISOString()},{id:"c02-l02",course_id:"c02",order_index:2,title:"Thinking Of vs. Thinking From",description:"The single most important shift in manifestation practice — and how to make it in any moment.",video_url:null,duration_seconds:900,is_preview:!1,content_md:`## Thinking Of vs. Thinking From
...
**That** is the thought stream to inhabit. Anything less is thinking *of*.`,created_at:new Date().toISOString()},{id:"c02-l03",course_id:"c02",order_index:3,title:"Living in the End",description:"Neville's most powerful instruction — what it actually means to inhabit the fulfilled state, and the common mistakes that prevent it.",video_url:null,duration_seconds:960,is_preview:!1,content_md:`## Living in the End
...
Notice how different these thoughts feel from thoughts *about* the desire.`,created_at:new Date().toISOString()},{id:"c02-l04",course_id:"c02",order_index:4,title:"The Bridge of Incidents",description:"The inevitable chain of events that moves your assumption into physical reality — and why you must never try to control it.",video_url:null,duration_seconds:840,is_preview:!1,content_md:`## The Bridge of Incidents
...
The subconscious is smarter than your conscious strategies. Trust the construction.`,created_at:new Date().toISOString()},{id:"c02-l05",course_id:"c02",order_index:5,title:"The Feeling Is the Secret",description:"Why emotion is the operative force — not visualization, not words, not logic — and how to generate genuine feeling on demand.",video_url:null,duration_seconds:780,is_preview:!1,content_md:`## The Feeling Is the Secret
...
Practice one of these today. Notice the difference between feeling *about* a desire and feeling *from* fulfillment.`,created_at:new Date().toISOString()},{id:"c02-l06",course_id:"c02",order_index:6,title:"The Echo Theory — Understanding the Delay",description:"Why nothing seems to change immediately after you shift your assumption — and what's actually happening beneath the surface.",video_url:null,duration_seconds:720,is_preview:!1,content_md:`## The Echo Theory — Understanding the Delay
...
Are you genuinely thinking from the new state more than the old? That is the only measure that matters during the delay. The external world is just catching up.`,created_at:new Date().toISOString()},{id:"c02-l07",course_id:"c02",order_index:7,title:"Module Quiz & Assumption Assignment",description:"Solidify your understanding of the Law of Assumption and receive your core practice for the next 30 days.",video_url:null,duration_seconds:300,is_preview:!1,content_md:`## Module Quiz & Assumption Assignment
...
The subconscious is being impressed. Persistently, deliberately, consistently — for 30 days. Then watch what echoes back.`,created_at:new Date().toISOString()}],r=[{id:"c03-l01",course_id:"c03",order_index:1,title:"What Is SATS — and Why It Works",description:"The science and mysticism behind the hypnagogic state — the most direct access point to the subconscious mind ever identified.",video_url:null,duration_seconds:840,is_preview:!1,content_md:`## What Is SATS — and Why It Works
...
Miss this window, and you'll either be too awake (critical factor active) or asleep (no conscious direction). This is why Course 3 exists — to teach you to catch the window and use it with precision.`,created_at:new Date().toISOString()},{id:"c03-l02",course_id:"c03",order_index:2,title:"Constructing Your SATS Scene",description:"The exact specifications for a scene that works — first-person, implied, short, looped. Why each element matters.",video_url:null,duration_seconds:960,is_preview:!1,content_md:`## Constructing Your SATS Scene
...
You don't think about the scene. You *live* the scene, over and over, until consciousness dissolves into sleep.`,created_at:new Date().toISOString()},{id:"c03-l03",course_id:"c03",order_index:3,title:"The 7-Night Integration Ritual",description:"The complete week-long protocol for building a layered subconscious foundation across 7 domains of your life.",video_url:null,duration_seconds:1020,is_preview:!1,content_md:`## The 7-Night Integration Ritual
...
Run this cycle, then repeat. Each iteration deepens the impression.`,created_at:new Date().toISOString()},{id:"c03-l04",course_id:"c03",order_index:4,title:"Myelination — The 21-Day Science",description:"Why consistency over 21 days creates permanent neural change — and how to structure your practice for maximum biological impact.",video_url:null,duration_seconds:780,is_preview:!1,content_md:`## Myelination — The 21-Day Science
...
21 nights. Same time. Same ritual. Begin tonight.`,created_at:new Date().toISOString()},{id:"c03-l05",course_id:"c03",order_index:5,title:"Common SATS Mistakes & How to Fix Them",description:"The 7 most frequent failure points in SATS practice — why they happen and exactly how to correct each one.",video_url:null,duration_seconds:900,is_preview:!1,content_md:`## Common SATS Mistakes & How to Fix Them
...
**Fix:** Label the evaluating thought as Beta-state interruption. Return immediately to the scene without engaging the thought.`,created_at:new Date().toISOString()},{id:"c03-l06",course_id:"c03",order_index:6,title:"SATS for Specific Desires",description:"How to customize your SATS scene for relationships, money, career, health, and creative work — with example scenes for each.",video_url:null,duration_seconds:840,is_preview:!1,content_md:`## SATS for Specific Desires
...
The subconscious has no limitation on how much it can receive. Be generous.`,created_at:new Date().toISOString()},{id:"c03-l07",course_id:"c03",order_index:7,title:"The Chemical Cement — Dopamine, Serotonin & the Impression Process",description:"Why positive emotion during SATS isn't just feel-good advice — it's the neurochemical mechanism that makes impressions permanent.",video_url:null,duration_seconds:720,is_preview:!1,content_md:`## The Chemical Cement
...
**Ease, warmth, and settled certainty** are not optional extras. They are the biological prerequisites for the impression to take hold.`,created_at:new Date().toISOString()},{id:"c03-l08",course_id:"c03",order_index:8,title:"Module Quiz & Your 21-Night SATS Commitment",description:"Assess your SATS mastery and formalize your 21-night practice commitment.",video_url:null,duration_seconds:300,is_preview:!1,content_md:`## Your 21-Night SATS Commitment
...
Complete the quiz below, then begin tonight.`,created_at:new Date().toISOString()}],l=[{id:"c04-l01",course_id:"c04",order_index:1,title:"The Mental Diet — What It Actually Means",description:"Neville's most demanding instruction — and the one most practitioners underestimate until they implement it fully.",video_url:null,duration_seconds:900,is_preview:!1,content_md:`## The Mental Diet
...
The mental diet shifts the score, one redirected thought at a time. By the end of a consistent day, you've cast hundreds of votes for the new reality.`,created_at:new Date().toISOString()},{id:"c04-l02",course_id:"c04",order_index:2,title:"The Decision Matrix",description:"A real-time tool for neutralizing limiting beliefs the moment they arise — without suppression, without spiritual bypass.",video_url:null,duration_seconds:840,is_preview:!1,content_md:`## The Decision Matrix
...
Three steps. 30 seconds. Repeat as needed, as many times as needed.`,created_at:new Date().toISOString()},{id:"c04-l03",course_id:"c04",order_index:3,title:"Staying Faithful When 3D Contradicts",description:"The hardest skill in manifestation practice — maintaining your inner state when external evidence says the opposite.",video_url:null,duration_seconds:960,is_preview:!1,content_md:`## Staying Faithful When 3D Contradicts
...
That peace is the most powerful signal you can send to the subconscious. It says: *this circumstance does not define me. I am the one who defines my reality.*`,created_at:new Date().toISOString()},{id:"c04-l04",course_id:"c04",order_index:4,title:"Advanced Revision — Rewriting the Timeline",description:"How to use the revision technique to neutralize not just today's events but years of accumulated emotional charge from the past.",video_url:null,duration_seconds:900,is_preview:!1,content_md:`## Advanced Revision — Rewriting the Timeline
...
Go to your Revision Journal. Identify one past experience to revise over the next week. Begin tonight.`,created_at:new Date().toISOString()},{id:"c04-l05",course_id:"c04",order_index:5,title:"Monitoring Your Inner Speech",description:"Building the observer capacity to catch inner dialogue in real time — the skill that makes every other practice work better.",video_url:null,duration_seconds:780,is_preview:!1,content_md:`## Monitoring Your Inner Speech
...
This is the mental diet working. One redirected thought at a time.`,created_at:new Date().toISOString()},{id:"c04-l06",course_id:"c04",order_index:6,title:"The Persistence Principle",description:"Why the practitioners who see the most dramatic results all share one quality — and how to develop it deliberately.",video_url:null,duration_seconds:840,is_preview:!1,content_md:`## The Persistence Principle
...
Track your practice publicly in the community forum. Share your journey — not just the results, but the quiet continuation during the delay. Accountability with others who understand the practice strengthens persistence more than almost anything else.`,created_at:new Date().toISOString()},{id:"c04-l07",course_id:"c04",order_index:7,title:"Integrated Practice — All Four Systems Working Together",description:"How the RAS framework, Law of Assumption, SATS, and Mental Diet function as one unified system — and how to run them simultaneously.",video_url:null,duration_seconds:900,is_preview:!1,content_md:`## Integrated Practice — All Four Systems Working Together
...
This is the architecture of a reality that you built, deliberately, from the inside out.`,created_at:new Date().toISOString()},{id:"c04-l08",course_id:"c04",order_index:8,title:"The Life Mastery Score — Monthly Assessment Protocol",description:"How to use the monthly Life Mastery Score diagnostic to track your internal shifts and generate your next-phase roadmap.",video_url:null,duration_seconds:600,is_preview:!1,content_md:`## The Life Mastery Score
...
Available in your Elite member dashboard. Complete monthly on the same date each month for consistent tracking.`,created_at:new Date().toISOString()},{id:"c04-l09",course_id:"c04",order_index:9,title:"Course Completion — Your Reality Architecture",description:"You've built the complete internal architecture. What comes next — and how to maintain what you've built.",video_url:null,duration_seconds:600,is_preview:!1,content_md:`## Your Reality Architecture Is Complete
...
✦`,created_at:new Date().toISOString()}],c={"c01-l05":{id:"quiz-c01-final",course_id:"c01",lesson_id:"c01-l05",title:"Course 1 Knowledge Check",description:null,quiz_type:"knowledge_check",tier_required:"free",pass_percent:70,created_at:new Date().toISOString(),questions:[{id:"q-c01-1",quiz_id:"quiz-c01-final",order_index:1,correct_option_id:"q-c01-1-b",explanation:"The RAS processes approximately 50 bits per second from the 11 million bits of incoming data — acting as the primary gatekeeper of conscious experience.",question:"How many bits per second does your conscious mind process from the 11 million incoming?",options:[{id:"q-c01-1-a",label:"A",text:"500 bits",feedback:null},{id:"q-c01-1-b",label:"B",text:"50 bits",feedback:null},{id:"q-c01-1-c",label:"C",text:"5,000 bits",feedback:null},{id:"q-c01-1-d",label:"D",text:"5 bits",feedback:null}]},{id:"q-c01-2",quiz_id:"quiz-c01-final",order_index:2,correct_option_id:"q-c01-2-c",explanation:"In Theta (4-7 Hz), the critical factor goes offline and the subconscious cannot distinguish imagination from reality — making it the ideal state for installing new beliefs.",question:'In which brainwave state is the "critical factor" offline and subconscious most receptive?',options:[{id:"q-c01-2-a",label:"A",text:"Beta (13–30 Hz)",feedback:null},{id:"q-c01-2-b",label:"B",text:"Alpha (8–12 Hz)",feedback:null},{id:"q-c01-2-c",label:"C",text:"Theta (4–7 Hz)",feedback:null},{id:"q-c01-2-d",label:"D",text:"Delta (0–4 Hz)",feedback:null}]},{id:"q-c01-3",quiz_id:"quiz-c01-final",order_index:3,correct_option_id:"q-c01-3-a",explanation:"The Car Model Phenomenon demonstrates that the RAS updated its filter after you made a decision — causing you to notice what was always there but previously filtered as noise.",question:"What does the Car Model Phenomenon demonstrate about the RAS?",options:[{id:"q-c01-3-a",label:"A",text:"The RAS filters for what matches your current emotional priorities",feedback:null},{id:"q-c01-3-b",label:"B",text:"More cars of that model appeared after your decision",feedback:null},{id:"q-c01-3-c",label:"C",text:"Desire creates objects in the physical world",feedback:null},{id:"q-c01-3-d",label:"D",text:"The RAS only responds to visual stimuli",feedback:null}]},{id:"q-c01-4",quiz_id:"quiz-c01-final",order_index:4,correct_option_id:"q-c01-4-d",explanation:"Myelination is the biological process by which repeated neural firing causes an insulating myelin sheath to form, making that pathway up to 120x faster — converting effortful belief into automatic assumption.",question:"What is the biological process that converts repeated thought into automatic belief?",options:[{id:"q-c01-4-a",label:"A",text:"Neurogenesis",feedback:null},{id:"q-c01-4-b",label:"B",text:"Synaptogenesis",feedback:null},{id:"q-c01-4-c",label:"C",text:"Dopaminergic encoding",feedback:null},{id:"q-c01-4-d",label:"D",text:"Myelination",feedback:null}]}]},"c02-l07":{id:"quiz-c02-final",course_id:"c02",lesson_id:"c02-l07",title:"Course 2 Knowledge Check",description:null,quiz_type:"knowledge_check",tier_required:"architect",pass_percent:70,created_at:new Date().toISOString(),questions:[{id:"q-c02-1",quiz_id:"quiz-c02-final",order_index:1,correct_option_id:"q-c02-1-b",explanation:"Thinking *from* means inhabiting the identity of someone who already has the desire — their natural thought stream, not thoughts about the desire itself.",question:'What is the core difference between "thinking of" and "thinking from" a desire?',options:[{id:"q-c02-1-a",label:"A",text:"Thinking from requires more emotional intensity",feedback:null},{id:"q-c02-1-b",label:"B",text:"Thinking from inhabits the identity of fulfillment; thinking of observes the desire from outside",feedback:null},{id:"q-c02-1-c",label:"C",text:"They produce identical subconscious impressions",feedback:null},{id:"q-c02-1-d",label:"D",text:"Thinking of is more powerful because it creates desire-energy",feedback:null}]},{id:"q-c02-2",quiz_id:"quiz-c02-final",order_index:2,correct_option_id:"q-c02-2-c",explanation:"The Echo Theory describes a 60-90 day lag between an internal assumption shift and its physical manifestation — 3D reality reflects past consciousness, not present.",question:"According to the Echo Theory, what does your current 3D reality reflect?",options:[{id:"q-c02-2-a",label:"A",text:"Your current assumptions in real-time",feedback:null},{id:"q-c02-2-b",label:"B",text:"The universe's response to your vibration today",feedback:null},{id:"q-c02-2-c",label:"C",text:"Your past assumptions, typically 60-90 days behind",feedback:null},{id:"q-c02-2-d",label:"D",text:"Your genetic programming and childhood conditioning",feedback:null}]},{id:"q-c02-3",quiz_id:"quiz-c02-final",order_index:3,correct_option_id:"q-c02-3-d",explanation:"The Bridge of Incidents is orchestrated by the subconscious — your role is to hold the assumption, not engineer the path. Trying to control the bridge undermines it.",question:"What is your role regarding the Bridge of Incidents?",options:[{id:"q-c02-3-a",label:"A",text:"Strategically engineer the most logical path to your desire",feedback:null},{id:"q-c02-3-b",label:"B",text:"Identify the bridge and accelerate it with focused action",feedback:null},{id:"q-c02-3-c",label:"C",text:"Trust specific people to be your bridge and cultivate them",feedback:null},{id:"q-c02-3-d",label:"D",text:"Hold the assumption and take inspired action — do not try to control the construction",feedback:null}]}]},"c03-l08":{id:"quiz-c03-final",course_id:"c03",lesson_id:"c03-l08",title:"SATS Mastery Diagnostic",description:null,quiz_type:"sats_diagnostic",tier_required:"architect",pass_percent:70,created_at:new Date().toISOString(),questions:[{id:"q-c03-1",quiz_id:"quiz-c03-final",order_index:1,correct_option_id:"q-c03-1-a",explanation:"SATS requires first-person perspective — you must be inside the scene, feeling it as a subject, not watching it as an observer.",question:"Which perspective is required for an effective SATS scene?",options:[{id:"q-c03-1-a",label:"A",text:"First-person — inside the scene, feeling it through your own senses",feedback:null},{id:"q-c03-1-b",label:"B",text:"Third-person — watching yourself receive the desired outcome",feedback:null},{id:"q-c03-1-c",label:"C",text:"Either perspective works equally well",feedback:null},{id:"q-c03-1-d",label:"D",text:"Aerial view — seeing the full scene from above",feedback:null}]},{id:"q-c03-2",quiz_id:"quiz-c03-final",order_index:2,correct_option_id:"q-c03-2-b",explanation:"The ideal SATS scene is 5-10 seconds — short enough to run in Theta without triggering Beta analytical thinking, long enough to carry full sensory and emotional detail.",question:"How long should an ideal SATS scene be?",options:[{id:"q-c03-2-a",label:"A",text:"2-3 minutes of detailed narrative",feedback:null},{id:"q-c03-2-b",label:"B",text:"5-10 seconds — a single moment looped",feedback:null},{id:"q-c03-2-c",label:"C",text:"30-60 seconds with multiple scenes",feedback:null},{id:"q-c03-2-d",label:"D",text:"As long as needed until you feel it",feedback:null}]},{id:"q-c03-3",quiz_id:"quiz-c03-final",order_index:3,correct_option_id:"q-c03-3-c",explanation:"Dopamine (anticipation/reward), serotonin (certainty/sufficiency), and norepinephrine encode the SATS session as a real, important experience — cementing the neural pathway.",question:'Which neurochemicals "cement" the SATS impression biologically?',options:[{id:"q-c03-3-a",label:"A",text:"Cortisol and adrenaline",feedback:null},{id:"q-c03-3-b",label:"B",text:"Melatonin and GABA",feedback:null},{id:"q-c03-3-c",label:"C",text:"Dopamine, serotonin, and norepinephrine",feedback:null},{id:"q-c03-3-d",label:"D",text:"Oxytocin and acetylcholine",feedback:null}]}]},"c04-l09":{id:"quiz-c04-final",course_id:"c04",lesson_id:"c04-l09",title:"Course 4 Final Assessment",description:null,quiz_type:"knowledge_check",tier_required:"elite",pass_percent:75,created_at:new Date().toISOString(),questions:[{id:"q-c04-1",quiz_id:"quiz-c04-final",order_index:1,correct_option_id:"q-c04-1-b",explanation:"The Mental Diet requires labeling the old program, refusing to engage (not suppress), and redirecting to the assumed identity's natural inner conversation.",question:"What are the three steps of the Decision Matrix?",options:[{id:"q-c04-1-a",label:"A",text:"Feel it, suppress it, replace it",feedback:null},{id:"q-c04-1-b",label:"B",text:"Identify the program, make the opposite decision, find evidence",feedback:null},{id:"q-c04-1-c",label:"C",text:"Name it, argue with it, affirm the opposite",feedback:null},{id:"q-c04-1-d",label:"D",text:"Observe it, accept it, release it",feedback:null}]},{id:"q-c04-2",quiz_id:"quiz-c04-final",order_index:2,correct_option_id:"q-c04-2-d",explanation:"Advanced revision targets past memories with emotional charge — using memory reconsolidation (a real neurological process) to neutralize old programs at the root.",question:"What neurological process does advanced revision leverage?",options:[{id:"q-c04-2-a",label:"A",text:"Neurogenesis — growing new neurons",feedback:null},{id:"q-c04-2-b",label:"B",text:"Synaptic pruning — removing unused connections",feedback:null},{id:"q-c04-2-c",label:"C",text:"Long-term potentiation",feedback:null},{id:"q-c04-2-d",label:"D",text:"Memory reconsolidation — updating memories when recalled",feedback:null}]},{id:"q-c04-3",quiz_id:"quiz-c04-final",order_index:3,correct_option_id:"q-c04-3-a",explanation:"Faithfulness during contradiction is the most important skill — the 3D echo is past programming, not present reality. Peace in the face of contradiction signals the assumed state.",question:"A 3D circumstance appears to contradict your assumption after 3 weeks of practice. The correct response is:",options:[{id:"q-c04-3-a",label:"A",text:'"This is the echo of the old state. My assumption is already hardening. I remain."',feedback:null},{id:"q-c04-3-b",label:"B",text:'"I need to intensify my SATS practice to overcome this resistance."',feedback:null},{id:"q-c04-3-c",label:"C",text:'"I should revise my goal to something more realistic."',feedback:null},{id:"q-c04-3-d",label:"D",text:'"The universe is testing my desire to see if I really want it."',feedback:null}]}]}},h={"c01-l01":{id:"lab-c01-01",lesson_id:"c01-l01",title:"The 11 Million Bit Filter",subtitle:"Exposing the Invisible Ceiling",scenario:"Usually, you see 'closed stores' or 'sold out' signs in your neighborhood. Your RAS is programmed to protect you by finding evidence of lack.",prompt:"What one opportunity has your RAS been filtering out because it didn't fit your old story of 'not enough'?",accentColor:"#E8621A"},"c02-l02":{id:"lab-c02-02",lesson_id:"c02-l02",title:"Thinking From vs. Of",subtitle:"The Tactile Shift",scenario:"You are currently 'thinking of' a beach (distance/wanting). Shift to 'thinking from' the beach (possession), while remembering the old desk as a distant dream.",prompt:"Describe the tactile feeling of the sand under your feet while remembering the old 'office self' as a distant, separate character.",accentColor:"#C9A84C"},"b01-l01":{id:"lab-b01-01",lesson_id:"b01-l01",title:"The Opportunity Filter",subtitle:"Beyond Firefighting",scenario:"Your team is currently in 'wait and see' mode regarding the new market changes. This is a passive filter.",prompt:"Identify one asset your company has that you've been 'ignoring' because it didn't fit the old success model.",accentColor:"#E8621A"}},d={c01:a,c02:s,c03:r,c04:l,b01:o};function u(e){return d[e]??[]}function m(e){return c[e.id]?c[e.id]:n[e.id]?n[e.id]:Object.values({...c,...n}).find(t=>t.course_id===e.course_id&&t.lesson_id?.endsWith(`l${e.order_index.toString().padStart(2,"0")}`))||null}function p(e){return h[e.id]?h[e.id]:Object.values(h).find(t=>t.lesson_id===`${e.course_id}-l${e.order_index.toString().padStart(2,"0")}`)||null}}};