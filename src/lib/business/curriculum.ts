  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        duration: "25 min",
        type: "workshop",
        description: "A structured 90-day protocol for installing a new professional identity assumption.",
        objectives: ["Design 90-day plan", "Build identity bridge", "Create accountability structures"],
        content: ["The 90-Day Shift operates in three phases: Foundation (days 1–30), Application (days 31–60), and Integration (days 61–90)."],
        tool: "90-Day Shift Planner",
      ...
      },
      {
        ...
        duration: "22 min",
        type: "video",
        description: "The Law of Assumption applied to professional identity: how to revise your self-concept and watch behavior follow.",
        objectives: ["Understand revision as neural reconsolidation", "Apply Evening Revision protocol", "Track identity evidence"],
        content: ["Revision isn't positive thinking — it's a neurological process of reconsolidating memory with a corrected self-assumption."],
        tool: "Evening Revision Protocol",
      ...
      },
      {
        ...
        type: "live",
        isLive: true,
        description: "Live facilitated session: identity architecture, assumption audit, and 90-day shift integration.",
        objectives: ["Map identity architecture", "Receive coaching on assumptions", "Finalize 90-day shift plan"],
        content: ["This live session integrates all five Track 03 modules into a personal development action plan."],
        tool: "Personal 90-Day Shift Commitment",
        quiz: [],
      },
    ],
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        duration: "22 min",
        type: "video",
        description: "Teams don't just have shared goals — they have shared assumptions. These assumptions determine collective performance.",
        objectives: ["Define collective assumption", "Identify team assumption patterns", "Map limiting vs. empowering team beliefs"],
        content: ["A team is a shared nervous system running on collective assumptions. What the group believes about itself determines what the group becomes."],
        tool: "Team Assumption Audit",
      ...
      },
      {
        ...
        duration: "25 min",
        type: "workshop",
        description: "High-frequency teams are self-accountable. This module builds the systems that make accountability intrinsic, not imposed.",
        objectives: ["Distinguish intrinsic vs. imposed accountability", "Build team accountability agreements", "Design accountability rhythms"],
        content: ["Imposed accountability requires a monitor. Intrinsic accountability is built into the team's identity."],
        tool: "Team Accountability Agreement Template",
      ...
      },
      {
        ...
        duration: "22 min",
        type: "workshop",
        description: "The communication patterns of high-frequency teams — how they speak, listen, and resolve friction before it escalates.",
        objectives: ["Identify high-frequency communication markers", "Apply the Clarity Protocol", "Build feedback culture"],
        content: ["High-frequency teams have a low friction-to-resolution ratio. Not because they have fewer conflicts, but because they resolve them faster."],
        tool: "Team Communication Clarity Protocol",
      ...
      },
      {
        ...
        duration: "20 min",
        type: "video",
        description: "The maintenance architecture that keeps high-frequency teams performing at peak — preventing drift and energetic decay.",
        objectives: ["Identify drift signals", "Build maintenance rhythms", "Design team renewal practices"],
        content: ["All high-performing systems drift without maintenance. Team frequency is no exception."],
        tool: "Team Frequency Maintenance Calendar",
      ...
      },
      {
        ...
        type: "live",
        isLive: true,
        description: "Live facilitated group workshop for team frequency mapping, assumption audit, and accountability architecture.",
        objectives: ["Complete team frequency map", "Build collective accountability agreement", "Design team maintenance rhythm"],
        content: ["This live workshop brings the entire Track 04 curriculum into a shared team experience."],
        tool: "Team Frequency Action Plan",
        quiz: [],
      },
    ],
  },
