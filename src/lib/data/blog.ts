...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: 'what-is-the-law-of-assumption',
    title: 'What Is the Law of Assumption? A Beginner\'s Guide',
    excerpt: 'The Law of Assumption is not the Law of Attraction. It doesn\'t ask you to think positive thoughts and wait. It asks you to assume — to inhabit the state of the wish already fulfilled.',
...
The Law of Assumption is not a technique. It is an understanding of how consciousness creates reality. And once you've seen it work — even once — the world never looks the same again.
  ...
  {
    slug: 'sats-state-akin-to-sleep-explained',
    title: 'SATS: The Most Powerful Manifestation Technique You\'re Not Using',
    excerpt: 'Every night, there\'s a 5-10 minute window between waking and sleep where your brain enters Theta waves and your subconscious becomes fully receptive. This is SATS — and it\'s your direct line to reality creation.',
    category: 'Techniques',
    readTime: 9,
...
One session is a seed. Thirty sessions is a garden.
  ...
  {
    slug: 'reticular-activating-system-reality',
    title: 'Your Brain Filters Reality — Here\'s How to Program It',
    excerpt: 'Your Reticular Activating System receives 11 million bits of data per second and lets only 50 into conscious awareness. You can decide which 50. This is the neuroscience of manifestation.',
...
The architecture of your reality is built by the filters in your mind. Vibe Hyr exists to help you become the architect.
  ...
  {
    slug: 'the-mental-diet-neville-goddard',
    title: 'The Mental Diet: The Only Diet That Actually Changes Your Life',
    excerpt: 'What if you monitored your thoughts the way a competitive athlete monitors food? Neville Goddard\'s Mental Diet is exactly that — a disciplined practice of feeding the subconscious only what you want to see reflected.',
    category: 'Mindset',
    readTime: 7,
...
It is, in every sense, the most demanding and the most rewarding practice available to a human being.
  ...
  {
    slug: 'revision-technique-rewrite-the-past',
    title: 'Neville Goddard\'s Revision Technique: How to Rewrite the Past',
    excerpt: 'The past is not fixed. Your memory of an event — and the emotional charge it carries — continues to shape your present. Revision lets you neutralize that charge and replace the impression before it can manifest.',
    category: 'Techniques',
    readTime: 8,
...
Revision is not escapism. It is housekeeping — clearing old programs before they generate more of what you don't want.
  ...
  {
    slug: 'echo-theory-delay-reality-lags',
    title: 'The Echo Theory: Why Your Reality Is 60-90 Days Behind Your Mind',
    excerpt: 'Current 3D reality is not your present state of consciousness. It is an echo — a projection of where your mind was 60 to 90 days ago. Understanding this changes everything about how you practice.',
    category: 'Foundations',
    readTime: 6,
...
The echo is not your enemy. It is simply old news. The new story has already been written inside. Give it time to arrive.
  ...
  {
    slug: 'thinking-from-vs-thinking-of',
    title: 'Thinking From vs. Thinking Of: The Most Important Distinction in Manifestation',
    excerpt: 'Neville Goddard\'s single most clarifying insight is the difference between thinking of your desire and thinking from it. One reinforces lack. The other creates reality.',
    category: 'Foundations',
    readTime: 5,
...
Move toward peace.
  ...
  {
    slug: 'how-to-do-sats-step-by-step',
    title: 'How to Do SATS: A Complete Step-by-Step Guide for Beginners',
    excerpt: 'You don\'t need an hour of meditation or a special environment. SATS takes 10 minutes, happens every night you sleep, and is the most direct method for subconscious reprogramming ever discovered.',
    category: 'Guides',
    readTime: 10,
...
This varies. Some people see results within days. Others within 30-90 days. Remember the echo delay — current reality is a projection of past consciousness. Be patient with the bridge.
  ...
  {
    slug: 'bridge-of-incidents-explained',
    title: 'The Bridge of Incidents: How the Subconscious Connects Your Assumption to Reality',
    excerpt: 'You don\'t need to know how your desire will manifest. The subconscious does. The Bridge of Incidents is the chain of events it arranges — and your only job is to walk it.',
    category: 'Foundations',
    readTime: 6,
...
The bridge is being built. Walk when it appears.
  ...
  {
    slug: 'limiting-beliefs-assumption-lab',
    title: 'How to Identify and Reprogram Your Limiting Beliefs',
    excerpt: 'Your limiting beliefs are not problems to be solved. They are old assumptions running on autopilot. Once you can see them clearly, you can replace them — one SATS session at a time.',
    category: 'Mindset',
    readTime: 8,
