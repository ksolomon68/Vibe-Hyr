...
import { ProgramGuideModal } from '@/components/education/ProgramGuideModal'
...
export default function EducationPage() {
  ...
  return (
    <main className="bg-black min-h-screen pt-20 text-white">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <button 
                ...
                className="px-8 py-4 bg-orange-DEFAULT hover:bg-orange-600 text-white text-[0.75rem] uppercase tracking-widest font-semibold rounded-sm transition-all shadow-xl shadow-orange-DEFAULT/20"
              >
      ...
      <section className="bg-ink py-24 md:py-32 px-6 md:px-14 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          <motion.div {...FADE_UP}>
            ...
            <button 
              onClick={() => setIsModalOpen(true)}
              className="px-10 py-5 bg-orange-DEFAULT hover:bg-orange-600 text-white text-[0.8rem] uppercase tracking-widest font-bold rounded-sm transition-all shadow-xl shadow-orange-DEFAULT/30"
            >
      ...
      <Footer />
      <ProgramGuideModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </main>
  )
}
