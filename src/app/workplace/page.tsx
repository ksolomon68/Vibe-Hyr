...
import { DiscoveryCallModal } from '@/components/workplace/DiscoveryCallModal'
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-[0.7rem] uppercase tracking-[0.3em] text-orange-DEFAULT font-bold">Workplace Culture Training</span>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <button 
                ...
                className="px-10 py-5 bg-orange-DEFAULT hover:bg-orange-600 text-white text-[0.8rem] uppercase tracking-widest font-bold rounded-sm transition-all shadow-xl shadow-orange-DEFAULT/20"
              >
                Get Training for Your Team
              </button>
              <a href="#curriculum" className="px-10 py-5 border border-white/20 hover:border-orange-DEFAULT hover:text-orange-DEFAULT text-white text-[0.8rem] uppercase tracking-widest font-bold rounded-sm transition-all">
                See the Curriculum
              </a>
            </div>
          </motion.div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-14 bg-zinc-900/50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
          <motion.div {...FADE_UP}>
            ...
            <button 
              onClick={() => setIsModalOpen(true)}
              className="px-10 py-5 bg-orange-DEFAULT hover:bg-orange-600 text-white text-[0.8rem] uppercase tracking-widest font-bold rounded-sm transition-all"
            >
      ...
      <section className="py-32 md:py-48 px-6 md:px-14 text-center relative overflow-hidden">
        ...
        <motion.div {...FADE_UP} className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
             <button 
                onClick={() => setIsModalOpen(true)}
                className="px-12 py-6 bg-orange-DEFAULT hover:bg-orange-600 text-white text-[0.8rem] uppercase tracking-widest font-bold rounded-sm transition-all shadow-2xl shadow-orange-DEFAULT/30"
              >
